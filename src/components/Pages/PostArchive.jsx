...
export default function PostArchive() {
  ...
  return (
    ...
    <div className="main-wrapper">
        ...
        <div className={"axil-breadcrumb-area breadcrumb-style-1 bg-color-grey" + themeColor}>
              ...
              <div className="col-lg-8 col-xl-8">
                ...
                <div className="content-block post-list-view mt--30">
                  ...
                  <div className="post-content">
                    ...
                    <h4 className="title"><a href="post-details.html">Security isn’t just a technology problem it’s about design, too</a></h4>
                    <div className="post-meta-wrapper">
                      <div className="post-meta">
                        <div className="content">
                          <h6 className="post-author-name">
