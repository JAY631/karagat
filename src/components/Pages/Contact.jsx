  ...
  return (
    <>
     <div className={showBurger ? "main-wrapper popup-mobile-menu-show" : 'main-wrapper'}>
        ...
        {/* Start Banner Area  */}
        <div className={"axil-banner banner-style-1 bg_image bg_image--3"}>
              ...
              <div className="col-lg-8 col-xl-8">
                ...
                <div className="axil-about-us">
                  <div className="inner">
                    ...
                    <p className="primary-color">Email: <a href="#">mepress@gmail.com</a></p>
                  </div>
                  {/* Start Contact Form  */}
                  <div className="axil-section-gapTop axil-contact-form-area">
                    <h4 className="title mb--10">Send Us a Message</h4>
                    <p className="b3 mb--30">Your email address will not be published. All the fields are required.</p>
                    <form id="contact-form" method="POST" action="mail.php" className="axil-contact-form contact-form--1 row">
                      <div className="col-lg-4 col-md-4 col-12">
                        <div className="form-group">
                          <label htmlFor="contact-name">Your Name</label>
                          <input name="contact-name" className='int' id="contact-name" type="text" />
                        </div>
                      </div>
                      <div className="col-lg-4 col-md-4 col-12">
                        <div className="form-group">
                          <label htmlFor="contact-phone">Phone</label>
                          <input type="text" className='int' name="contact-phone" id="contact-phone" />
                        </div>
                      </div>
                      <div className="col-lg-4 col-md-4 col-12">
                        <div className="form-group">
                          <label>Your Email</label>
                          <input htmlFor="contact-email" name="contact-email" id="contact-email" className='int' type="email" />
                        </div>
                      </div>
                      <div className="col-12">
                        <div className="form-group">
                          <label htmlFor="contact-message">Your Message</label>
                          <textarea className='int' name="contact-message" id="contact-message" defaultValue={""} />
                        </div>
                      </div>
                      <div className="col-12">
                        <div className="form-submit">
                          <button name="submit" type="submit" id="submit" className="axil-button button-rounded btn-primary">Submit</button>
                        </div>
                      </div>
                    </form>
                  </div>
