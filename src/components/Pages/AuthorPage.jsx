  ...
  return (
    <>
     <div className={showBurger ? "main-wrapper popup-mobile-menu-show" : 'main-wrapper'}>
        ...
        {/* Start Author Area  */}
        <div className={"axil-author-area axil-author-banner bg-color-grey" + themeColor}>
              ...
              <div className="col-lg-8 col-xl-8">
                ...
                <div className="content-block post-list-view mt--30">
                  <div className="post-thumbnail">
                    <a href="post-details.html">
                      <img src={postList01} alt="Post Images" />
                    </a>
                    <a className="video-popup icon-color-secondary size-medium position-top-center" href="post-details.html"><span className="play-icon" /></a>
                  </div>
                  <div className="post-content">
                    <div className="post-cat">
                      <div className="post-cat-list">
                    ...
                    <h4 className="title"><a href="post-details.html">The 1 tool that helps remote teams
                ...
                <div className="content-block post-list-view mt--30">
                  ...
                  <div className="post-content">
                    ...
                    <h4 className="title"><a href="post-details.html">Traditional design won’t save us in the
                        COVID-19 era</a></h4>
                    <div className="post-meta-wrapper">
                      <div className="post-meta">
                        <div className="content">
                ...
                <div className="content-block post-list-view mt--30">
                  ...
                  <div className="post-content">
                    ...
                    <h4 className="title"><a href="post-details.html">New: Freehand Templates, built for the
                        whole team</a></h4>
                    <div className="post-meta-wrapper">
                      <div className="post-meta">
                        <div className="content">
                ...
                <div className="content-block post-list-view mt--30">
                  ...
                  <div className="post-content">
                    ...
                    <h4 className="title"><a href="post-details.html">Get Ready To Up Your Creative Game With
