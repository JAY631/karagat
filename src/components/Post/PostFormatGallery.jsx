...
export default function PostFormatGallery() {
              ...
              <div className="col-lg-8">
                ...
                <div className="axil-post-details">
                  ...
                  <figure className="wp-block-image">
                    <div className="post-gallery-activation axil-slick-arrow arrow-between-side">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/U3v5yMF1hTs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        ...
                        <div className="row row--10">
                          <div className="col-lg-4 col-md-4 col-12">
                            <div className="form-group">
                              ...
                              <input id="name" type="text" className='int' />
                            </div>
                          </div>
                          <div className="col-lg-4 col-md-4 col-12">
                            <div className="form-group">
                              <label htmlFor="email">Your Email</label>
                              <input id="email" type="email" className='int' />
                            </div>
                          </div>
                          <div className="col-lg-4 col-md-4 col-12">
                            <div className="form-group">
                              <label htmlFor="website">Your Website</label>
                              <input id="website" type="text" className='int' />
                            </div>
                          </div>
                          <div className="col-12">
                            <div className="form-group">
                              <label htmlFor="message">Leave a Reply</label>
                              <textarea id="message" className='int' name="message" defaultValue={""} />
                            </div>
                          </div>
                          <div className="col-lg-12">
                ...
                <div className="sidebar-inner">
                  ...
                  <div className="axil-single-widget widget widget_newsletter mb--30">
                    ...
                    <div className="newsletter-inner text-center">
                      ...
                      <p className="b2 mb--30">Sign up for free and be the first to <br /> get notified about updates.</p>
                      <form action="#">
                        <div className="form-group">
                          <input type="text" className='int' placeholder="Enter Your Email " />
                        </div>
                        <div className="form-submit">
                          <button className="cerchio axil-button button-rounded"><span>Subscribe</span></button>
                        </div>
                      </form>
                    </div>
                    {/* End Post List  */}
                    ...
                    <div className="video-post-wrapepr">
                      ...
                      <div className="content-block image-rounded">
                        <div className="post-content">
                          <div className="post-thumbnail">
                            ...
                            <a className="video-popup size-medium icon-color-secondary position-top-center" href="post-details.html"><span className="play-icon" /></a>
                          </div>
                          <h6 className="title mt--10"><a href="post-details.html">I built my own camera with a Raspberry Pi 4</a>
                          </h6>
                        </div>
                      </div>
                      {/* End Post List  */}
                      ...
                      <div className="content-block image-rounded mt--20">
                        <div className="post-content">
                          ...
                          <h6 className="title mt--10"><a href="post-details.html">A rocket launch can’t unite us until the space
                      ...
                      <div className="content-block image-rounded mt--20">
                        <div className="post-content">
                          ...
                          <h6 className="title mt--10"><a href="post-details.html"> With iOS 14, Apple is finally letting the
                  ...
                  <div className="axil-banner">
                    <div className="thumbnail">
                      <a href="#">
                        <img className="w-100" src={banner02} alt="Banner Images" />
                      </a>
                    </div>
                  </div>
                </div>
