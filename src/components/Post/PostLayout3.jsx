...
export default function PostLayout3() {
  ...
  return (
    <>
      <div className={showBurger ? "main-wrapper popup-mobile-menu-show" : 'main-wrapper'}>
        ...
        {/* Start Banner Area */}
        <div className={"banner banner-single-post post-layout-3 post-formate post-standard bg_image bg_image--2 d-flex align-items-end"/* + themeColor*/}>
                ...
                <div className="sidebar-inner">
                  ...
                  <div className="axil-single-widget widget widget_newsletter mb--30">
                    ...
                    <div className="newsletter-inner text-center">
                      ...
                      <form action="#">
                        <div className="form-group">
                          <input className='int' type="text" placeholder="Enter Your Email " />
                        </div>
