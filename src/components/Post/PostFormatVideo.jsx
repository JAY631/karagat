...
export default function PostFormatVideo() {
                ...
                <div className="axil-post-details">
                  ...
                  <figure className="wp-block-image">
                    {/* <div class="post-images">
                                    <img src="assets/images/post-single/post-single-05.jpg" alt="Post Images">
                                    <a class="video-popup position-top-center" href="post-details.html"><span
                                            class="play-icon"></span></a>
                                </div> */}
                    <div className="embed-responsive embed-responsive-16by9">
                      <iframe src="http://www.youtube.com/embed/U3v5yMF1hTs?origin=http://axilthemes.com/" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
                    </div>
